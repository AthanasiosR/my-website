...
export const ProjectsData = [
  {
    ...
    description:
      "An E-commerce website that displays items that are for sale. Features include multiple categories pages / an items detail page / a cart / a checkout modal for the customers information / an order confirmation page.",
    languagesUsed: [
      "HTML & CSS,",
      " JavaScript,",
      " React,",
  ...
  },
  {
    ...
    description:
      "Cricker is a Twitter clone project. The project fetches tweet data from database and displays all tweets on a homepage. Features include: A home page / A profile page for the user / Can post a tweet / Can also “like” a tweet",
